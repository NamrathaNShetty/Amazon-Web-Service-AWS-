...
def describe_ec2_instance():
    '''
    Description:
        In this method we are getting instance id.
    '''
    try:
...
def reboot_ec2_instance():
    '''
    Description:
        In this method we are rebooting instance.
    '''
    try:
...
def stop_ec2_instance():
    '''
    Description:
        In this method we stopping instance.
    '''
    try:
...
def start_ec2_instance():
    '''
    Description:
        In this method we are starting instance.
    '''
    try:
...
def terminate_ec2_instance():
    '''
    Description:
        In this method we are terminating instance.
    '''
    try:
